...
import type { ISkill } from '@util/skills';
...
interface IProps {
  setSkillsHandler : (e : any) => void
}
export default function CustomizedHook({setSkillsHandler} : IProps) {
  ...
  return (
    <Root className='m-8'>
      ...
      <span className='mt-[2px] pl-1 text-xs text-gray-700'>Max 4 skills*</span>
    </Root>
  );
}
